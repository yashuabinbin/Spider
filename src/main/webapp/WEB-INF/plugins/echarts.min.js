!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = n(2), n(107), n(101), n(111), n(191), n(207), n(232), n(55), n(209), n(208), n(223), n(216), n(215), n(214), n(197), n(224), n(239)
    }, function (t, e) {
        function n(t) {
            ...
            } else if (E[i])e = t.constructor.from(t); else if (!O[i] && !L(t) && !T(t)) {
                e = {};
        ...
        function i(t, e, r) {
            ...
            for (var o in e)if (e.hasOwnProperty(o)) {
                var a = t[o], s = e[o];
                !M(s) || !M(a) || _(s) || _(a) || T(s) || T(a) || S(s) || S(a) || L(s) || L(a) ? !r && o in t || (t[o] = n(e[o], !0)) : i(a, s, r)
            }
            return t
        }
        ...
        function l() {
            return D || (D = W.createCanvas().getContext("2d")), D
        }
        ...
        function f(t, e, n) {
            if (t && e)if (t.forEach && t.forEach === R)t.forEach(e, n); else if (t.length === +t.length)for (var i = 0, r = t.length; i < r; i++)e.call(n, t[i], i, t); else for (var o in t)t.hasOwnProperty(o) && e.call(n, t[o], o, t)
        }

        function p(t, e, n) {
            if (t && e) {
                if (t.map && t.map === F)return t.map(e, n);
        ...
        function g(t, e, n, i) {
            if (t && e) {
                if (t.reduce && t.reduce === G)return t.reduce(e, n, i);
        ...
        }, z = Object.prototype.toString, N = Array.prototype, R = N.forEach, B = N.filter, V = N.slice, F = N.map, G = N.reduce, H = "__ec_primitive__", W = {
            inherits: h,
            mixin: c,
            clone: n,
            merge: i,
        ...
        function o(t, e, n) {
            ...
            var o = this._zr = z.init(t, {renderer: n.renderer || "canvas", devicePixelRatio: n.devicePixelRatio, width: n.width, height: n.height});
        ...
        function l(t, e) {
            var n = t.type, i = t.escapeConnect, r = nt[n], o = r.actionInfo, a = (o.update || "update").split(":"), l = a.pop();
        ...
        function d(t, e) {
            ...
            e[n ? "eachComponent" : "eachSeries"](function (t, a) {
                ...
                if (!l) {
                    var u = G(a.type), h = n ? k.getClass(u.main, u.sub) : L.getClass(u.sub);
                    if (!h)return;
                    l = new h, l.init(e, this._api), r[s] = l, i.push(l), o.add(l.group)
                }
                a.__viewId = l.__id = s, l.__alive = !0, l.__model = a, l.group.__ecComponentInfo = {mainType: a.mainType, index: a.componentIndex}
            }, this);
        ...
        function b(t) {
            ...
            return N.extend(new T(t), {
                getCoordinateSystems: N.bind(e.getCoordinateSystems, e), getComponentByElement: function (e) {
                    for (; e;) {
         ...
         */
        var M = n(9), S = n(137), T = n(100), A = n(26), I = n(138), C = n(13), P = n(19), k = n(64), L = n(30), D = n(3), O = n(6), E = n(37), z = n(87), N = n(1), R = n(22), B = n(23), V = n(51), F = N.each, G = C.parseClassType, H = 1e3, W = 5e3, Z = 1e3, q = 2e3, j = 3e3, U = 4e3, X = 5e3, Y = "__flagInMainProcess", $ = "__hasGradientOrPatternBg", K = "__optionUpdated", Q = /^[a-zA-Z0-9_]+$/;
        ...
        J._onframe = function () {
            ...
            this.__lastOnlyGraphic = !(!t || !t.graphic), N.each(t, function (t, e) {
                "graphic" !== e && (this.__lastOnlyGraphic = !1)
            }, this), this._model.setOption(t, ot, this.__lastOnlyGraphic), n ? (this[K] = {silent: i}, this[Y] = !1) : (tt.prepareAndUpdate.call(this), this._zr.flush(), this[K] = !1, this[Y] = !1, u.call(this, i), h.call(this, i))
        }, J.setTheme = function () {
                ...
                if (ct[e]) {
                    ...
                    N.each(ht, function (r, h) {
                        if (r.group === e) {
                            ...
                            o = n(d.left, o), a = n(d.top, a), s = i(d.right, s), l = i(d.bottom, l), u.push({dom: c, left: d.left, top: d.top})
                        }
                    }), o *= h, a *= h, s *= h, l *= h;
                    ...
                    return F(u, function (t) {
                        var e = new D.Image({style: {x: t.left * h - o, y: t.top * h - a, image: t.dom}});
                        p.add(e)
        ...
        var tt = {
            update: function (t) {
                ...
                var e = this._model;
                d.call(this, "component", e), d.call(this, "chart", e), this.__lastOnlyGraphic ? (F(this._componentsViews, function (n) {
                    var i = n.__model;
                    i && "graphic" === i.mainType && (n.render(i, e, this._api, t), _(i, n))
                }, this), this.__lastOnlyGraphic = !1) : tt.update.call(this, t)
            }
        };
        J.resize = function (t) {
        ...
        var nt = {}, it = {}, rt = [], ot = [], at = [], st = [], lt = {}, ut = {}, ht = {}, ct = {}, dt = new Date - 0, ft = new Date - 0, pt = "_echarts_instance_", gt = {
            version: "3.5.3",
            dependencies: {zrender: "3.4.3"}
        };
        gt.init = function (t, e, n) {
            var i = new o(t, e, n);
            return i.id = "ec_" + dt++, ht[i.id] = i, t.setAttribute && t.setAttribute(pt, i.id), w(i), i
            ...
            N.isDom(t) ? t = gt.getInstanceByDom(t) : "string" == typeof t && (t = ht[t]), t instanceof o && !t.isDisposed() && t.dispose()
            ...
            event: "downplay",
            update: "downplay"
        }, N.noop), gt.zrender = z, gt.List = n(14), gt.Model = n(10), gt.Axis = n(33), gt.graphic = n(3), gt.number = n(4), gt.format = n(7), gt.throttle = E.throttle, gt.matrix = n(16), gt.vector = n(5), gt.color = n(22), gt.util = {}, F(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend", "defaults", "clone", "merge"], function (t) {
            gt.util[t] = N[t]
        ...
        var m = n(1), v = n(180), y = Math.round, x = n(8), _ = n(22), b = n(16), w = n(5), M = n(57), S = n(11), T = {};
        T.Group = n(36), T.Image = n(53), T.Text = n(85), T.Circle = n(171), T.Sector = n(177), T.Ring = n(176), T.Polygon = n(173), T.Polyline = n(174), T.Rect = n(175), T.Line = n(172), T.BezierCurve = n(170), T.Arc = n(169), T.CompoundPath = n(164), T.LinearGradient = n(99), T.RadialGradient = n(165), T.BoundingRect = S, T.extendShape = function (t) {
            return x.extend(t)
        }, T.extendPath = function (t, e) {
            return v.extendFromString(t, e)
        }, T.makePath = function (t, e, n, i) {
        ...
        }, T.setText = function (t, e, n) {
            var i = e.getShallow("position") || "inside", r = e.getShallow("offset"), o = i.indexOf("inside") >= 0 ? "white" : n, a = e.getModel("textStyle");
            m.extend(t, {
        ...
        }, T.updateProps = function (t, e, n, i, r) {
            g(!0, t, e, n, i, r)
        }, T.initProps = function (t, e, n, i, r) {
            g(!1, t, e, n, i, r)
        }, T.getTransform = function (t, e) {
            for (var n = b.identity([]); t && t !== e;)b.mul(n, t.getLocalTransform(), n), t = t.parent;
            return n
        }, T.applyTransform = function (t, e, n) {
            return e && !m.isArrayLike(e) && (e = M.getLocalTransform(e)), n && (e = b.invert([], e)), w.applyTransform([], t, e)
        }, T.transformDirection = function (t, e, n) {
            ...
            return o = T.applyTransform(o, e, n), Math.abs(o[0]) > Math.abs(o[1]) ? o[0] > 0 ? "right" : "left" : o[1] > 0 ? "bottom" : "top"
        }, T.groupTransition = function (t, e, n, i) {
            function r(t) {
                var e = {};
            ...
            if (t && e) {
                ...
                e.traverse(function (t) {
                    if (!t.isGroup && t.anid) {
                        ...
                        if (e) {
                            var i = o(t);
                            t.attr(o(e)), T.updateProps(t, i, n, t.dataIndex)
                        }
                    }
                })
            }
        ...
        r.getTimezoneOffset = function () {
            ...
            if ("string" == typeof t) {
                ...
                var n = r.getTimezoneOffset(), i = e[8] ? "Z" === e[8].toUpperCase() ? n : 60 * +e[8].slice(0, 3) + n : 0;
            ...
            var n, r = i(t), o = Math.pow(10, r), a = t / o;
            return n = e ? a < 1.5 ? 1 : a < 2.5 ? 2 : a < 4 ? 3 : a < 7 ? 5 : 10 : a < 1 ? 1 : a < 2 ? 2 : a < 3 ? 3 : a < 5 ? 5 : 10, t = n * o, r >= -20 ? +t.toFixed(r < 0 ? -r : 0) : t
        ...
        h.normalizeToArray = function (t) {
            ...
            getDataParams: function (t, e) {
                var n = this.getData(e), i = this.getRawValue(t, e), r = n.getRawIndex(t), o = n.getName(t, !0), a = n.getRawDataItem(t);
                return {
        ...
        var r = n(38), o = n(1), a = n(27), s = n(161), l = n(71), u = l.prototype.getCanvasPattern, h = Math.abs, c = new a((!0));
        i.prototype = {
        ...
        var i = {};
        i = "undefined" == typeof navigator ? {browser: {}, os: {}, node: !0, canvasSupported: !0} : n(navigator.userAgent), t.exports = i
    }, function (t, e, n) {
        function i(t, e, n) {
        ...
        var r = n(5), o = n(16), a = r.applyTransform, s = Math.min, l = Math.max;
        i.prototype = {
        ...
        var r = n(1), o = n(11), a = n(4), s = n(7), l = a.parsePercent, u = r.each, h = {}, c = h.LOCATION_PARAMS = ["left", "right", "top", "bottom", "width", "height"], d = h.HV_NAMES = [["width", "left", "right"], ["height", "top", "bottom"]];
        ...
        (function (e) {
            ...
            function r(t, e) {
                var n = t.dimensions, i = new v(d.map(n, t.getDimensionInfo, t), t.hostModel);
                m(i, t);
            ...
            var o = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === o ? Array : a.Float64Array, l = typeof a.Int32Array === o ? Array : a.Int32Array, u = {
                ...
                number: Array,
                time: Array
            }, h = n(10), c = n(48), d = n(1), f = n(6), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"], m = function (t, e) {
                d.each(g.concat(e.__wrappedMethods || []), function (n) {
                    e.hasOwnProperty(n) && (t[n] = e[n])
                ...
                for (var n = {}, i = [], r = 0; r < t.length; r++) {
                    ...
                    "string" == typeof t[r] ? (o = t[r], a = {
                        ...
                        stackable: !1,
                        type: "number"
                    }) : (a = t[r], o = a.name, a.type = a.type || "number"), i.push(o), n[o] = a
                }
            ...
            y.type = "list", y.hasItemOption = !0, y.getDimension = function (t) {
                ...
                t = t || [], this._rawData = t;
                var i = this._storage = {}, r = this.indices = [], o = this.dimensions, a = t.length, s = this._dimensionInfos, l = [], h = {};
                e = e || [];
                ...
                n || (g.hasItemOption = !1), n = n || function (t, e, n, i) {
                        ...
                        return f.isDataItemOption(t) && (g.hasItemOption = !0), f.converDataValue(r instanceof Array ? r[i] : r, s[e])
                    };
                ...
                var i = [];
                d.isArray(t) || (n = e, e = t, t = this.dimensions);
                ...
                "function" == typeof t && (r = n, n = e, e = t, t = []), t = d.map(i(t), this.getDimension, this);
                ...
                for (var u = 0; u < l.length; u++) {
                    var h;
                    if (1 === s)h = e.call(r, this.get(t[0], u, n), u); else {
            ...
            }, y.map = function (t, e, n, o) {
                t = d.map(i(t), this.getDimension, this);
                ...
                this._itemLayouts[t] = n ? d.extend(this._itemLayouts[t] || {}, e) : e
            ...
            y.setItemGraphicEl = function (t, e) {
                ...
                d.each(this._graphicEls, function (n, i) {
                    n && t && t.call(e, n, i)
                })
        ...
        function o(t, e, n, i) {
            var r = e.x, o = e.y, a = e.height, s = e.width, l = n.height, u = n.lineHeight, h = a / 2 - l / 2 + u, c = "left";
            switch (t) {
                case"left":
                    r -= i, o += h, c = "right";
                    break;
        ...
        var i = n(149), r = n(43);
        n(150), n(148);
        var o = n(34), a = n(4), s = n(1), l = n(17), u = {};
        u.getScaleExtent = function (t, e) {
            ...
            "log" === t.type && (t.base = e.get("logBase")), t.setExtent(n[0], n[1]), t.niceExtent(o, i, r);
            var a = e.get("minInterval");
            if (isFinite(a) && !i && !r && "interval" === t.type) {
                var s = t.getInterval(), l = Math.max(Math.abs(s), a) / s;
                n = t.getExtent();
                var h = (n[1] + n[0]) / 2;
                t.setExtent(l * (n[0] - h) + h, l * (n[1] - h) + h), t.niceExtent(o)
            }
        ...
        "use strict";
        var i = n(1), r = n(7), o = n(15), a = n(6), s = n(13), l = n(61), u = n(9), h = n(12), c = o.set, d = o.get, f = r.encodeHTML, p = r.addCommas, g = s.extend({
            ...
            formatTooltip: function (t, e, n) {
                function o(t) {
                    ...
                    return i.each(t, function (t, i) {
                        var o, s = a.getDimensionInfo(i), l = s && s.type;
                        o = "ordinal" === l ? t + "" : "time" === l ? e ? "" : r.formatTime("yyyy/MM/dd hh:mm:ss", t) : p(t), o && n.push(o)
                    }), n.join(", ")
                }

                var a = d(this, "data"), s = this.getRawValue(t), l = f(i.isArray(s) ? o(s) : p(s)), u = a.getName(t), h = a.getItemVisual(t, "color");
                i.isObject(h) && h.colorStops && (h = (h.colorStops[0] || {}).color), h = h || "transparent";
                var c = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + f(h) + '"></span>', g = this.name;
        ...
        function s(t, e, n, r, o, a) {
            ...
            if (i(c) && i(d))if (i(l))a[0] = 0; else {
                ...
                if (i(m)) {
                    ...
                    var A = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), I = Math.acos(A) / 3, C = b(c), P = Math.cos(I), g = (-l - 2 * C * P) / (3 * s), y = (-l + C * (P + S * Math.sin(I))) / (3 * s), k = (-l + C * (P - S * Math.sin(I))) / (3 * s);
                    g >= 0 && g <= 1 && (a[p++] = g), y >= 0 && y <= 1 && (a[p++] = y), k >= 0 && k <= 1 && (a[p++] = k)
                }
            }
            return p
        }
        ...
        var v = n(5), y = v.create, x = v.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-8, M = 1e-4, S = b(3), T = 1 / 3, A = y(), I = y(), C = y();
        t.exports = {
            cubicAt: o,
            cubicDerivativeAt: a,
            cubicRootAt: s,
        ...
        t.exports = {clientToLocal: r, normalizeEvent: a, addEventListener: s, removeEventListener: l, stop: d, Dispatcher: u}
    }, function (t, e, n) {
        function i(t) {
        ...
        function i(t, e, n) {
            ...
            if (null == i) {
                var s = r(e[0]);
                i = o.isArray(s) && s.length || 1
            }
            for (var l = n.defaultNames || [], u = n.extraPrefix || "extra", h = 0; h < i; h++)if (!t[h]) {
                var c = l[h] || u + (h - l.length);
                t[h] = a(e, h) ? {type: "ordinal", name: c} : c
            }
            return t
        }
        ...
        var o = n(1), a = i.guessOrdinal = function (t, e) {
        ...
        "use strict";
        var i = n(20), r = n(5), o = n(84), a = n(11), s = n(35).devicePixelRatio, l = {
            M: 1,
            L: 2,
            C: 3,
            Q: 4,
            ...
            Z: 6,
            R: 7
        }, u = [], h = [], c = [], d = [], f = Math.min, p = Math.max, g = Math.cos, m = Math.sin, v = Math.sqrt, y = Math.abs, x = "undefined" != typeof Float32Array, _ = function (t) {
        ...
        _.prototype = {
            ...
            _dashedLineTo: function (t, e) {
                var n, i, r = this._dashSum, o = this._dashOffset, a = this._lineDash, s = this._ctx, l = this._xi, u = this._yi, h = t - l, c = e - u, d = v(h * h + c * c), g = l, m = u, y = a.length;
            ...
            _dashedBezierTo: function (t, e, n, r, o, a) {
                var s, l, u, h, c, d = this._dashSum, f = this._dashOffset, p = this._lineDash, g = this._ctx, m = this._xi, y = this._yi, x = i.cubicAt, _ = 0, b = this._dashIdx, w = p.length, M = 0;
                ...
                for (var e, n, i, r, o, a, s = this.data, u = this._ux, h = this._uy, c = this._len, d = 0; d < c;) {
                    ...
                    switch (1 == d && (i = s[d], r = s[d + 1], e = i, n = r), f) {
                        ...
                        case l.Q:
                            ...
                            break;
                        case l.A:
                            var p = s[d++], v = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], M = s[d++], S = s[d++], T = x > _ ? x : _, A = x > _ ? 1 : x / _, I = x > _ ? _ / x : 1, C = Math.abs(x - _) > .001, P = b + w;
        ...
        function o(t, e, n) {
            t = t || [];
            var i = e.get("coordinateSystem"), o = m[i], a = f.get(i), s = o && o(t, e, n), v = s && s.dimensions;
            v || (v = a && (a.getDimensionsInfo ? a.getDimensionsInfo() : a.dimensions.slice()) || ["x", "y"], v = h(v, t, {defaultNames: v.concat(["value"])}));
            var y = s ? s.categoryIndex : -1, x = new u(v, e), _ = l(s, t), b = {}, w = y >= 0 && r(t) ? function (t, e, n, i) {
                return d.isDataItemOption(t) && (x.hasItemOption = !0), i === y ? n : g(p(t), v[i])
            } : function (t, e, n, i) {
                var r = p(t), o = g(r && r[i], v[i]);
        ...
        var u = n(14), h = n(25), c = n(1), d = n(6), f = n(26), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, n) {
                var i = c.map(["xAxis", "yAxis"], function (t) {
                    return n.queryComponents({mainType: t, index: e.get(t + "Index"), id: e.get(t + "Id")})[0]
                }), r = i[0], o = i[1], l = r.get("type"), u = o.get("type"), d = [{name: "x", type: s(l), stackable: a(l)}, {
                    name: "y",
                    type: s(u),
                    stackable: a(u)
                }], f = "category" === l, p = "category" === u;
                h(d, t, {defaultNames: ["x", "y", "z"]});
                var g = {};
                return f && (g.x = r), p && (g.y = o), {dimensions: d, categoryIndex: f ? 0 : p ? 1 : -1, categoryAxesModels: g}
            }, singleAxis: function (t, e, n) {
                var i = n.queryComponents({
                    mainType: "singleAxis",
                    index: e.get("singleAxisIndex"),
                    id: e.get("singleAxisId")
                })[0], r = i.get("type"), o = "category" === r, l = [{name: "single", type: s(r), stackable: a(r)}];
                h(l, t);
                var u = {};
                return o && (u.single = i), {dimensions: l, categoryIndex: o ? 0 : -1, categoryAxesModels: u}
            }, polar: function (t, e, n) {
                var i = n.queryComponents({
                    mainType: "polar",
                    index: e.get("polarIndex"),
                    id: e.get("polarId")
                })[0], r = i.findAxisModel("angleAxis"), o = i.findAxisModel("radiusAxis"), l = o.get("type"), u = r.get("type"), c = [{
                    name: "radius",
                    type: s(l),
                    stackable: a(l)
                }, {name: "angle", type: s(u), stackable: a(u)}], d = "category" === u, f = "category" === l;
                h(c, t, {defaultNames: ["radius", "angle", "value"]});
                var p = {};
                return f && (p.radius = o), d && (p.angle = r), {dimensions: c, categoryIndex: d ? 1 : f ? 0 : -1, categoryAxesModels: p}
            }, geo: function (t, e, n) {
                return {dimensions: h([{name: "lng"}, {name: "lat"}], t, {defaultNames: ["lng", "lat", "value"]})}
            }
        };
        t.exports = o
    }, function (t, e) {
        ...
        var a = n(36), s = n(49), l = n(15), u = n(6), h = n(1);
        i.prototype = {
        ...
        n(56), n(116), o.extendComponentView({
        ...
        var r = n(4), o = r.linearMap, a = n(1), s = [0, 1], l = function (t, e, n) {
        ...
        l.prototype = {
            constructor: l, contain: function (t) {
                ...
                return t = r.normalize(t), this.onBand && "ordinal" === r.type && (n = n.slice(), i(n, r.count())), o(t, s, n, e)
        ...
        var i = n(1), r = n(65), o = n(11), a = function (t) {
            t = t || {}, r.call(this, t);
        ...
        var r = n(1), o = n(72), a = n(65), s = n(86);
        i.prototype = {
            constructor: i,
            type: "displayable",
            __dirty: !0,
        ...
        var l = n(1), u = n(7), h = n(3), c = n(10), d = n(4), f = d.remRadian, p = d.isRadianAroundZero, g = n(5), m = n(16), v = g.applyTransform, y = l.retrieve, x = Math.PI, _ = function (t, e) {
        ...
        var b = {
            axisLine: function () {
                ...
                if (r && !n.scale.isBlank()) {
                    var s = e.getModel("axisLabel"), u = s.getModel("textStyle"), d = s.get("margin"), f = n.scale.getTicks(), p = e.getFormattedLabels(), g = (y(t.labelRotate, s.get("rotate")) || 0) * x / 180, m = w(t.rotation, g, t.labelDirection), v = e.get("data"), _ = [], b = o(e), S = e.get("triggerEvent");
                    l.each(f, function (r, o) {
                        if (!M(n, o, t.labelInterval)) {
                            var a = u;
                            v && v[r] && v[r].textStyle && (a = new c(v[r].textStyle, u, e.ecModel));
                            var s = a.getTextColor() || e.get("axisLine.lineStyle.color"), l = n.dataToCoord(r), f = [l, t.labelOffset + t.labelDirection * d], g = n.scale.getLabel(r), y = new h.Text({
                                anid: "label_" + r,
                                style: {
                                    text: p[o],
                ...
                if (n) {
                    ...
                    var b = d.getFont(), M = e.get("nameTruncate", !0) || {}, S = M.ellipsis, T = y(t.nameTruncateMaxWidth, M.maxWidth, _), A = null != S && null != T ? u.truncateText(n, T, b, S, {
                        minChar: 2,
                        placeholder: M.placeholder
                    }) : n, I = e.get("tooltip", !0), C = e.mainType, P = {componentType: C, name: n, $vars: ["name"]};
        ...
        var o = n(45), a = n(2).extendComponentView({
            type: "axis", _axisPointer: null, axisPointerClass: null, render: function (t, e, n, r) {
        ...
        var i = n(4), r = n(7), o = n(34), a = n(63), s = i.round, l = o.extend({
            type: "interval", _interval: 0, _intervalPrecision: 2, setExtent: function (t, e) {
                ...
                return this._interval || this.niceTicks(), a.intervalScaleGetTicks(this._interval, this._extent, this._niceExtent, this._intervalPrecision)
                ...
                if (isFinite(n)) {
                    n < 0 && (n = -n, e.reverse());
                    var i = a.intervalScaleNiceTicks(e, t);
                    this._intervalPrecision = i.intervalPrecision, this._interval = i.interval, this._niceExtent = i.niceTickExtent
                }
                ...
                var o = i[1] - i[0];
                isFinite(o) || (i[0] = 0, i[1] = 1), this.niceTicks(t);
                var a = this._interval;
                e || (i[0] = s(Math.floor(i[0] / a) * a)), n || (i[1] = s(Math.ceil(i[1] / a) * a))
            }
        });
        l.create = function () {
            return new l
            ...
            c(n.getCoordinateSystems(), function (n) {
                function h(i, h, c) {
                    ...
                    if (f && ("auto" !== f || i || l(d))) {
                        ...
                        var m = d.get("snap"), y = p(c.model), x = h || m || "category" === c.type, _ = t.axesInfo[y] = {
                            key: y,
                            axis: c,
                            coordSys: n,
                            axisPointerModel: d,
                ...
                if (n.axisPointerEnabled) {
                    ...
                    if (c(n.getAxes(), d(h, !1, null)), n.getTooltipAxes && i && v.get("show")) {
                        var y = "axis" === v.get("trigger"), x = "cross" === v.get("axisPointer.type"), _ = n.getTooltipAxes(v.get("axisPointer.axis"));
        ...
        function o(t, e) {
            e.eachSeries(function (e) {
                ...
                n && "none" !== i && i !== !1 && "item" !== i && e.get("axisPointer.show", !0) !== !1 && c(t.coordSysAxesInfo[p(n.model)], function (t) {
                    var i = t.axis;
        ...
        var o = n(1), a = n(9), s = n(2), l = n(6), u = n(76), h = n(198), c = o.each, d = u.eachAxisDim, f = s.extendComponentModel({
            type: "dataZoom",
        ...
        i.prototype = {
            constructor: i, add: function (t) {
                ...
                var t, e = this._old, n = this._new, i = this._oldKeyGetter, o = this._newKeyGetter, a = {}, s = {}, l = [], u = [];
        ...
        var r = n(38), o = n(11), a = n(1), s = n(69), l = new s(50);
        i.prototype = {
        ...
        var s = n(1), l = n(24), u = n(3), h = n(4), c = o.prototype;
        c._createSymbol = function (t, e, n, i) {
            this.removeAll();
            var o = e.hostModel, s = e.getItemVisual(n, "color"), h = l.createSymbol(t, -1, -1, 2, 2, s);
            h.attr({z2: 100, culling: !0, scale: [0, 0]}), h.drift = a, u.initProps(h, {scale: r(i)}, o, n), this._symbolType = t, this.add(h)
        ...
        var d = ["itemStyle", "normal"], f = ["itemStyle", "emphasis"], p = ["label", "normal"], g = ["label", "emphasis"];
        c._updateCommon = function (t, e, n, i) {
            var o = this.childAt(0), a = t.hostModel, l = t.getItemVisual(e, "color");
            "image" !== o.type && o.useStyle({strokeNoScale: !0}), i = i || null;
            var c = i && i.itemStyle, m = i && i.hoverItemStyle, v = i && i.symbolRotate, y = i && i.symbolOffset, x = i && i.labelModel, _ = i && i.hoverLabelModel, b = i && i.hoverAnimation;
            ...
            var M = o.style;
            o.attr("rotation", (v || 0) * Math.PI / 180 || 0), y && o.attr("position", [h.parsePercent(y[0], n[0]), h.parsePercent(y[1], n[1])]), o.setColor(l), o.setStyle(c);
            ...
            null != T && x.getShallow("show") ? (u.setText(M, x, l), M.text = s.retrieve(a.getFormattedLabel(e, "normal"), t.get(T, e))) : M.text = "", null != T && _.getShallow("show") ? (u.setText(m, _, l), m.text = s.retrieve(a.getFormattedLabel(e, "emphasis"), t.get(T, e))) : m.text = "", o.off("mouseover").off("mouseout").off("emphasis").off("normal"), o.hoverStyle = m, u.setHoverStyle(o);
            var C = r(n);
            if (b && a.isAnimationEnabled()) {
                ...
                o.on("mouseover", P).on("mouseout", k).on("emphasis", P).on("normal", k)
            }
        ...
        n(194), n(195), n(119), i.registerPreprocessor(function (t) {
            if (t) {
        ...
        }), i.registerAction({type: "updateAxisPointer", event: "updateAxisPointer", update: ":updateAxisPointer"}, function (t, e, n) {
            var i = o(e.getComponent("axisPointer").coordSysAxesInfo, t.currTrigger, [t.x, t.y], t, t.dispatchAction || a.bind(n.dispatchAction, n), e, n, t.tooltipOption, t.highDownKey);
            return i
        })
    }, function (t, e, n) {
        function i(t, e, n) {
        ...
        var u = n(12), h = n(18), c = n(1), d = n(132), f = n(130), p = c.each, g = h.ifAxisCrossZero, m = h.niceScaleExtent;
        n(133);
        var v = o.prototype;
        v.type = "grid", v.axisPointerEnabled = !0, v.getRect = function () {
            ...
            function n() {
                p(o, function (t) {
                    ...
                    t.setExtent(n[r], n[1 - r]), a(t, e ? i.x : i.y)
                })
            }

            var i = u.getLayoutRect(t.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()});
            this._rect = i;
            var o = this._axesList;
            n(), t.get("containLabel") && (p(o, function (t) {
                if (!t.model.get("axisLabel.inside")) {
                    var e = r(t);
                    if (e) {
                        var n = t.isHorizontal() ? "height" : "width", o = t.model.get("axisLabel.margin");
                        i[n] -= e[n] + o, "top" === t.position ? i.y += e.height + o : "left" === t.position && (i.x += e.width + o)
                    }
                }
            }), n())
        ...
        o.create = function (t, e) {
            ...
            return t.eachComponent("grid", function (i, r) {
                var a = new o(i, t, e);
                a.name = "grid_" + r, a.resize(i, e), i.coordinateSystem = a, n.push(a)
        ...
        var r = n(16), o = n(5), a = r.identity, s = 5e-5, l = function (t) {
        ...
        var i = n(94), r = n(1), o = n(13), a = n(12), s = ["value", "category", "time", "log"];
        ...
        var r = n(13), o = n(1), a = n(58), s = r.extend({
        ...
        a.intervalScaleNiceTicks = function (t, e) {
            var n = {}, i = t[1] - t[0], s = n.interval = r.nice(i / e, !0), l = n.intervalPrecision = r.getPrecisionSafe(s) + 2, u = n.niceTickExtent = [o(Math.ceil(t[0] / s) * s, l), o(Math.floor(t[1] / s) * s, l)];
            return a.fixExtent(u, t), n
        ...
        "use strict";
        var i = n(70), r = n(23), o = n(57), a = n(178), s = n(1), l = function (t) {
        ...
        function s(t, e, n, i, r) {
            var a = t.length;
            if (1 == r)for (var s = 0; s < a; s++)i[s] = o(t[s], e[s], n); else for (var l = t[0].length, s = 0; s < a; s++)for (var u = 0; u < l; u++)i[s][u] = o(t[s][u], e[s][u], n)
        }
        ...
        function l(t, e, n) {
            ...
            if (i !== r) {
                var o = i > r;
                if (o)t.length = r; else for (var a = i; a < r; a++)t.push(1 === n ? e[a] : x.call(e[a]))
            }
        ...
        function p(t, e, n, i, r) {
            var d = t._getter, p = t._setter, v = "spline" === e, x = i.length;
            if (x) {
                var _, b = i[0].value, w = y(b), M = !1, S = !1, T = w && y(b[0]) ? 2 : 1;
                i.sort(function (t, e) {
                    return t.time - e.time
                }), _ = i[x - 1].time;
                for (var A = [], I = [], C = i[0].value, P = !0, k = 0; k < x; k++) {
                    A.push(i[k].time / _);
                    var L = i[k].value;
                    if (w && u(L, C, T) || !w && L === C || (P = !1), C = L, "string" == typeof L) {
                        var D = m.parse(L);
                        D ? (L = D, M = !0) : S = !0
                    }
                    I.push(L)
                ...
                if (!P) {
                    for (var O = I[x - 1], k = 0; k < x - 1; k++)w ? l(I[k], O, T) : !isNaN(I[k]) || isNaN(O) || S || M || (I[k] = O);
                    w && l(d(t._target, r), O, T);
                    var E, z, N, R, B, V, F = 0, G = 0;
                    if (M)var H = [0, 0, 0, 0];
                    var W = function (t, e) {
                        var n;
                        if (e < 0)n = 0; else if (e < G) {
                            for (E = Math.min(F + 1, x - 1), n = E; n >= 0 && !(A[n] <= e); n--);
                            n = Math.min(n, x - 2)
                        } else {
                            for (n = F; n < x && !(A[n] > e); n++);
                            n = Math.min(n - 1, x - 2)
                        ...
                        F = n, G = e;
                        var i = A[n + 1] - A[n];
                        if (0 !== i)if (z = (e - A[n]) / i, v)if (R = I[n], N = I[0 === n ? n : n - 1], B = I[n > x - 2 ? x - 1 : n + 1], V = I[n > x - 3 ? x - 1 : n + 2], w)h(N, R, B, V, z, z * z, z * z * z, d(t, r), T); else {
                            var l;
                            if (M)l = h(N, R, B, V, z, z * z, z * z * z, H, 1), l = f(H); else {
                                if (S)return a(R, B, z);
                                l = c(N, R, B, V, z, z * z, z * z * z)
                            }
                            p(t, r, l)
                        } else if (w)s(I[n], I[n + 1], z, d(t, r), T); else {
                            var l;
                            if (M)s(I[n], I[n + 1], z, H, 1), l = f(H); else {
                                if (S)return a(I[n], I[n + 1], z);
                                l = o(I[n], I[n + 1], z)
                            }
                            p(t, r, l)
                        }
                    }, Z = new g({target: t._target, life: _, loop: t._loop, delay: t._delay, onframe: W, ondestroy: n});
                    return e && "spline" !== e && (Z.easing = e), Z
                }
            }
        }

        var g = n(157), m = n(22), v = n(1), y = v.isArrayLike, x = Array.prototype.slice, _ = function (t, e, n, o) {
        ...
        r.layout = function (t, e, n) {
            ...
            n = n || {};
            var o = t.coordinateSystem, a = e.axis, s = {}, l = a.position, u = a.onZero ? "onZero" : l, h = a.dim, c = o.getRect(), d = [c.x, c.x + c.width, c.y, c.y + c.height], f = e.get("offset") || 0, p = {
                x: {
                    top: d[2] - f,
                    bottom: d[3] + f
                }, y: {left: d[0] - f, right: d[1] + f}
            };
        ...
        var r = n(1), o = n(3), a = n(17), s = n(7), l = n(16), u = n(18), h = n(40), c = {};
        c.buildElStyle = function (t) {
            ...
            }), h = n.getModel("label"), d = h.getModel("textStyle"), f = s.normalizeCssArray(h.get("padding") || 0), p = d.getFont(), g = a.getBoundingRect(u, p, o.textAlign, o.textBaseline), m = o.position, v = g.width + f[1] + f[3], y = g.height + f[0] + f[2], x = o.align;
        ...
        t.exports = function (t, e, n, i, r) {
            function o(t, e, n) {
                ...
                return e[0] > e[1] && i.reverse(), t < 0 && i[0] + t < n[0] && (t = n[0] - i[0]), t > 0 && i[1] + t > n[1] && (t = n[1] - i[1]), t
            }

            return t ? ("rigid" === i ? (t = o(t, e, n), e[0] += t, e[1] += t) : (t = o(t, e[r], n), e[r] += t, "push" === i && e[0] > e[1] && (e[1 - r] = e[r])), e) : e
        }
    }, function (t, e, n) {
        function i(t) {
        ...
        var r = n(6), o = n(1), a = n(9), s = n(7), l = s.addCommas, u = s.encodeHTML, h = n(2).extendComponentModel({
            type: "marker",
        ...
        t.exports = n(2).extendComponentView({
            type: "marker", init: function () {
                ...
                for (var r in i)i.hasOwnProperty(r) && (i[r].__keep = !1);
                var o = this.type + "Model";
                e.eachSeries(function (t) {
                    var i = t[o];
                    i && this.renderSeries(t, i, e, n)
                }, this);
                for (var r in i)i.hasOwnProperty(r) && !i[r].__keep && this.group.remove(i[r].group)
        ...
        var s = n(1), l = n(4), u = s.indexOf, h = s.curry, c = {min: h(a, "min"), max: h(a, "max"), average: h(a, "average")}, d = function (t, e) {
        ...
        var i = n(5), r = n(20), o = {}, a = Math.min, s = Math.max, l = Math.sin, u = Math.cos, h = i.create(), c = i.create(), d = i.create(), f = 2 * Math.PI;
        ...
        var i = n(38), r = n(1), o = n(17), a = function (t) {
            i.call(this, t)
        };
        a.prototype = {
            constructor: a, type: "text", brush: function (t, e) {
                ...
                var t = this.style;
                if (!this._rect) {
                    var e = t.textVerticalAlign, n = o.getBoundingRect(t.text + "", t.textFont || t.font, t.textAlign, e ? "top" : t.textBaseline);
                    switch (e) {
                        case"middle":
                            n.y -= n.height / 2;
                            break;
        ...
        var r = n(17), o = n(11), a = new o, s = function () {
        };
        s.prototype = {
            constructor: s, drawRectText: function (t, e, n) {
                ...
                if (null != s && (s += ""), s) {
                    t.save();
                    var l, u, h = o.textPosition, c = o.textOffset, d = o.textDistance, f = o.textAlign, p = o.textFont || o.font, g = o.textBaseline, m = o.textVerticalAlign;
         ...
         */
        var r = n(70), o = n(9), a = n(1), s = n(152), l = n(155), u = n(156), h = n(163), c = !o.canvasSupported, d = {canvas: n(154)}, f = {}, p = {};
        p.version = "3.4.3", p.init = function (t, e) {
            var n = new g(r(), t, e);
            return f[n.id] = n, n
            ...
            for (var _ = 0, b = n, w = 0; w < r; w++) {
                ...
                if (b === n)t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(f, M); else if (v > 0) {
                    ...
                    if (!T || i(T))c(p, M); else {
                        ...
                        if ("x" === y || "y" === y) {
                            var k = "x" === y ? 0 : 1;
                            C = Math.abs(M[k] - I[k]), P = Math.abs(M[k] - T[k])
        ...
        var a = n(8), s = n(5), l = s.min, u = s.max, h = s.scaleAndAdd, c = s.copy, d = [], f = [], p = [];
        t.exports = {
            Polyline: a.extend({
                type: "ec-polyline",
        ...
        function i(t) {
            this.pointerChecker, this._zr = t;
            var e = c.bind, n = e(r, this), i = e(o, this), u = e(a, this), d = e(s, this), f = e(l, this);
            h.call(this), this.setPointerChecker = function (t) {
                this.pointerChecker = t
            }, this.enable = function (e) {
                this.disable(), null == e && (e = !0), e !== !0 && "move" !== e && "pan" !== e || (t.on("mousedown", n), t.on("mousemove", i), t.on("mouseup", u)), e !== !0 && "scale" !== e && "zoom" !== e || (t.on("mousewheel", d), t.on("pinch", f))
            }, this.disable = function () {
                t.off("mousedown", n), t.off("mousemove", i), t.off("mouseup", u), t.off("mousewheel", d), t.off("pinch", f)
        ...
        function o(t) {
            if (this._dragging && (d.stop(t.event), "pinch" !== t.gestureEvent)) {
                ...
                this._x = e, this._y = n, d.stop(t.event), this.trigger("pan", o, a, i, r, e, n)
            }
        }
        ...
        function u(t, e, n, i) {
            this.pointerChecker && this.pointerChecker(t, n, i) && (d.stop(t.event), this.trigger("zoom", e, n, i))
        }

        var h = n(23), c = n(1), d = n(21), f = n(128);
        c.mixin(i, h), t.exports = i
    }, function (t, e, n) {
        var i = n(1), r = {
            show: !0,
            zlevel: 0,
            ...
            axisLabel: {show: !0, inside: !1, rotate: 0, showMinLabel: null, showMaxLabel: null, margin: 8, textStyle: {fontSize: 12}},
        ...
        function o(t, e) {
            ...
            s.each(t, function (t, e) {
                var o = t.getData(), a = t.coordinateSystem, s = a.getBaseAxis(), l = s.getExtent(), h = "category" === s.type ? s.getBandWidth() : Math.abs(l[1] - l[0]) / o.count(), c = n[r(s)] || {
                        bandWidth: h,
                        remainedWidth: h,
                        autoWidthCount: 0,
                        categoryGap: "20%",
            ...
            return s.each(n, function (t, e) {
                o[e] = {};
                var n = t.stacks, i = t.bandWidth, r = u(t.categoryGap, i), a = u(t.gap, 1), l = t.remainedWidth, h = t.autoWidthCount, c = (l - r) / (h + (h - 1) * a);
                c = Math.max(c, 0), s.each(n, function (t, e) {
                    var n = t.maxWidth;
                    n && n < c && (n = Math.min(n, l), t.width && (n = Math.min(n, t.width)), l -= n, t.width = n, h--)
                ...
                s.each(n, function (t, n) {
                    o[e][n] = o[e][n] || {offset: p, width: t.width}, p += t.width * (1 + a)
                })
            }), o
        }
        ...
        function a(t, e, n) {
            ...
            e.eachSeriesByType(t, function (t) {
                var e = t.getData(), n = t.coordinateSystem, o = n.getBaseAxis(), s = i(t), h = a[r(o)][s], c = h.offset, d = h.width, f = n.getOtherAxis(o), p = t.get("barMinHeight") || 0, g = o.onZero ? f.toGlobalCoord(f.dataToCoord(0)) : f.getGlobalExtent()[0], m = n.dataToPoints(e, !0);
                l[s] = l[s] || [], u[s] = u[s] || [], e.setLayout({offset: c, size: d}), e.each(f.dim, function (t, n) {
                    if (!isNaN(t)) {
                        l[s][n] || (l[s][n] = {p: g, n: g}, u[s][n] = {p: g, n: g});
                        var i, r, o, a, h = t >= 0 ? "p" : "n", v = m[n], y = l[s][n][h], x = u[s][n][h];
                        f.isHorizontal() ? (i = y, r = v[1] + c, o = v[0] - x, a = d, u[s][n][h] += o, Math.abs(o) < p && (o = (o < 0 ? -1 : 1) * p), l[s][n][h] += o) : (i = v[0] + c, r = y, o = d, a = v[1] - x, u[s][n][h] += a, Math.abs(a) < p && (a = (a <= 0 ? -1 : 1) * p), l[s][n][h] += a), e.setItemLayout(n, {
                            x: i,
                            y: r,
                            width: o,
                            height: a
        ...
        var s = n(1), l = n(4), u = l.parsePercent;
        t.exports = a
    }, function (t, e) {
        t.exports = {
        ...
        t.exports = n(89).extend({type: "series.bar", dependencies: ["grid", "polar"], brushSelector: "rect"})
    }, function (t, e, n) {
        "use strict";
        function i(t, e, n, i, r, o, a) {
            var s = new u.Rect({shape: l.extend({}, i)});
            if (o) {
                var h = s.shape, c = r ? "height" : "width", d = {};
                h[c] = 0, d[c] = i[c], u[a ? "updateProps" : "initProps"](s, {shape: d}, o, e)
            }
            return s
        }

        function r(t, e, n) {
            n.style.text = "", u.updateProps(n, {shape: {width: 0}}, e, t, function () {
                n.parent && n.parent.remove(n)
            })
        }

        function o(t, e, n) {
            var i = t.getItemLayout(e), r = s(n, i), o = i.width > 0 ? 1 : -1, a = i.height > 0 ? 1 : -1;
            return {x: i.x + o * r / 2, y: i.y + a * r / 2, width: i.width - o * r, height: i.height - a * r}
        }

        function a(t, e, n, i, r, o, a) {
            var s = e.getItemVisual(n, "color"), c = e.getItemVisual(n, "opacity"), d = i.getModel("itemStyle.normal"), f = i.getModel("itemStyle.emphasis").getBarItemStyle();
            t.setShape("r", d.get("barBorderRadius") || 0), t.useStyle(l.defaults({fill: s, opacity: c}, d.getBarItemStyle()));
            var p = a ? r.height > 0 ? "bottom" : "top" : r.width > 0 ? "left" : "right";
            h.setLabel(t.style, f, i, s, o, n, p), u.setHoverStyle(t, f)
        }
        ...
        var l = n(1), u = n(3), h = n(90), c = ["itemStyle", "normal", "barBorderWidth"];
        l.extend(n(10).prototype, n(104));
        var d = n(2).extendChartView({
            type: "bar", render: function (t, e, n) {
                var i = t.get("coordinateSystem");
                return "cartesian2d" === i && this._renderOnCartesian(t, e, n), this.group
            }, dispose: l.noop, _renderOnCartesian: function (t, e, n) {
                var s = this.group, l = t.getData(), h = this._data, c = t.coordinateSystem, d = c.getBaseAxis(), f = d.isHorizontal(), p = t.isAnimationEnabled() ? t : null;
                l.diff(h).add(function (e) {
                    if (l.hasValue(e)) {
                        var n = l.getItemModel(e), r = o(l, e, n), u = i(l, e, n, r, f, p);
                        l.setItemGraphicEl(e, u), s.add(u), a(u, l, e, n, r, t, f)
                    }
                }).update(function (e, n) {
                    var r = h.getItemGraphicEl(n);
                    if (!l.hasValue(e))return void s.remove(r);
                    var c = l.getItemModel(e), d = o(l, e, c);
                    r ? u.updateProps(r, {shape: d}, p, e) : r = i(l, e, c, d, f, p, !0), l.setItemGraphicEl(e, r), s.add(r), a(r, l, e, c, d, t, f)
                }).remove(function (t) {
        ...
        var u = n(24), h = n(5), c = n(190), d = n(3), f = n(1), p = n(4), g = ["fromSymbol", "toSymbol"], m = l.prototype;
        m.beforeUpdate = s, m._createLine = function (t, e, n) {
            ...
            r.useStyle(f.defaults({strokeNoScale: !0, fill: "none", stroke: h, opacity: c}, o)), r.hoverStyle = a, f.each(g, function (t) {
        ...
        var a = n(3), s = n(105), l = o.prototype;
        ...
        n(108), n(109), r.registerVisual(i.curry(n(50), "line", "circle", "line")), r.registerLayout(i.curry(n(60), "line")), r.registerProcessor(o.PROCESSOR.STATISTIC, i.curry(n(147), "line")), n(32)
    }, function (t, e, n) {
        "use strict";
        var i = n(28), r = n(19);
        t.exports = r.extend({
        ...
        t.exports = _.extend({
            type: "line", init: function () {
                ...
                if (k = r(t.get("smooth")), x.setShape({
                    ...
                    var L = l.stackedOn, D = 0;
                    if (_.useStyle(f.defaults(p.getAreaStyle(), {fill: P, opacity: .7, lineJoin: "bevel"})), L) {
                        var O = L.hostModel;
                        D = r(O.get("smooth"))
                    }
        ...
        var i = n(1), r = n(2);
        n(112), n(113), n(88)("pie", [{type: "pieToggleSelect", event: "pieselectchanged", method: "toggleSelected"}, {
            type: "pieSelect",
            event: "pieselected",
            method: "select"
        }, {
            ...
            event: "pieunselected",
            method: "unSelect"
        }]), r.registerVisual(i.curry(n(83), "pie")), r.registerLayout(i.curry(n(115), "pie")), r.registerProcessor(i.curry(n(62), "pie"))
    }, function (t, e, n) {
        "use strict";
        var i = n(14), r = n(1), o = n(6), a = n(25), s = n(77), l = n(2).extendSeriesModel({
            type: "series.pie",
            init: function (t) {
            ...
            getInitialData: function (t, e) {
                var n = a(["value"], t.data), r = new i(n, this);
                return r.initData(t.data), r
            },
            getDataParams: function (t) {
                var e = this.getData(), n = l.superCall(this, "getDataParams", t), i = e.getSum("value");
        ...
        u.updateData = function (t, e, n) {
            ...
            a.useStyle(l.defaults({
                lineJoin: "bevel",
                fill: g
            }, p.getModel("normal").getItemStyle())), a.hoverStyle = p.getModel("emphasis").getItemStyle(), r(this, t.getItemLayout(e), h.get("selected"), u.get("selectedOffset"), u.get("animation")), a.off("mouseover").off("mouseout").off("emphasis").off("normal"), h.get("hoverAnimation") && u.isAnimationEnabled() && a.on("mouseover", i).on("mouseout", o).on("emphasis", i).on("normal", o), this._updateLabel(t, e), s.setHoverStyle(this)
        }, u._updateLabel = function (t, e) {
            var n = this.childAt(1), i = this.childAt(2), r = t.hostModel, o = t.getItemModel(e), l = t.getItemLayout(e), u = l.label, h = t.getItemVisual(e, "color");
        ...
        var h = n(30).extend({
            type: "pie", init: function () {
                ...
                if (!r || r.from !== this.uid) {
                    var a = t.getData(), s = this._data, u = this.group, h = e.get("animation"), c = !s, d = t.get("animationType"), f = l.curry(i, this.uid, t, h, n), p = t.get("selectedMode");
                    if (a.diff(s).add(function (t) {
                        ...
                        var g = a.getItemLayout(0), m = Math.max(n.getWidth(), n.getHeight()) / 2, v = l.bind(u.removeClipPath, u);
        ...
        t.exports = function (t, e, n, i) {
            ...
            l.each(function (n) {
                var i, r, c, d, f = l.getItemLayout(n), p = l.getItemModel(n), g = p.getModel("label.normal"), m = g.get("position") || p.get("label.emphasis.position"), v = p.getModel("labelLine.normal"), y = v.get("length"), x = v.get("length2"), _ = (f.startAngle + f.endAngle) / 2, b = Math.cos(_), w = Math.sin(_);
                a = f.cx, s = f.cy;
                ...
                var k = g.getModel("textStyle").getFont(), L = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0, D = t.getFormattedLabel(n, "normal") || l.getName(n), O = o.getBoundingRect(D, k, d, "top");
                h = !!L, f.label = {
                    x: i,
                    y: r,
                    position: m,
        ...
        var i = n(4), r = i.parsePercent, o = n(114), a = n(1), s = 2 * Math.PI, l = Math.PI / 180;
        t.exports = function (t, e, n, u) {
            e.eachSeriesByType(t, function (t) {
                var e = t.get("center"), u = t.get("radius");
                a.isArray(u) || (u = [0, u]), a.isArray(e) || (e = [e, e]);
                var h = n.getWidth(), c = n.getHeight(), d = Math.min(h, c), f = r(e[0], h), p = r(e[1], c), g = r(u[0], d / 2), m = r(u[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l, x = t.get("minAngle") * l, _ = v.getSum("value"), b = Math.PI / (_ || v.count()) * 2, w = t.get("clockwise"), M = t.get("roseType"), S = t.get("stillShowZeroSum"), T = v.getDataExtent("value");
                T[0] = 0;
                var A = s, I = 0, C = y, P = w ? 1 : -1;
                if (v.each("value", function (t, e) {
                        ...
                        n = "area" !== M ? 0 === _ && S ? b : t * b : s / (v.count() || 1), n < x ? (n = x, A -= x) : I += t;
                        var r = C + P * n;
                        v.setItemLayout(e, {
                            angle: n,
                            startAngle: C,
                    ...
                    var n = v.getItemLayout(e), i = n.angle === x ? x : t * b;
                    n.startAngle = C, n.endAngle = C + P * i, C += P * i
                });
                o(t, m, h, c)
            })
        }
        ...
        var i = n(1), r = n(3), o = n(40), a = n(41), s = n(74), l = o.ifIgnoreOnTick, u = o.getInterval, h = ["axisLine", "axisLabel", "axisTick", "axisName"], c = ["splitArea", "splitLine"], d = a.extend({
            type: "cartesianAxis",
            ...
            _splitArea: function (t, e, n) {
                var o = t.axis;
                if (!o.scale.isBlank()) {
                    var a = t.getModel("splitArea"), s = a.getModel("areaStyle"), h = s.get("color"), c = e.coordinateSystem.getRect(), d = o.getTicksCoords(), f = o.scale.getTicks(), p = o.toGlobalCoord(d[0]), g = o.toGlobalCoord(d[0]), m = 0, v = u(a, n), y = s.getAreaStyle();
                    h = i.isArray(h) ? h : [h];
        ...
        function l(t, e) {
            var n = t.get("icon"), i = {x: -1, y: -1, width: 2, height: 2}, r = h.extend({
        ...
        var h = n(1), c = n(15), d = n(3), f = n(6).makeGetter(), p = n(45), g = n(21), m = n(37), v = h.clone, y = h.bind;
        i.prototype = {
            _group: null,
            ...
            _doDispatchAxisPointer: function () {
                var t = this._handle;
                if (t) {
                    var e = this._payloadInfo, n = {
                        type: "updateAxisPointer",
                        x: e.cursorPoint[0],
                        y: e.cursorPoint[1],
                        tooltipOption: e.tooltipOption,
                        highDownKey: "axisPointerHandle"
                    }, i = this._axisModel.axis;
                    n[i.dim + "AxisId"] = this._axisModel.id, this._api.dispatchAction(n)
                }
            },
        ...
        var o = n(3), a = n(118), s = n(75), l = n(74), u = n(41), h = a.extend({
        ...
        var l = n(9), u = n(1), h = n(6).makeGetter(), c = u.each, d = {};
        ...
        function x(t, e, n, i) {
            var r = i.brushStyle.lineWidth || 0, o = U(r, K), a = n[0][0], s = n[1][0], l = a - r / 2, u = s - r / 2, h = n[0][1], c = n[1][1], d = h - o + r / 2, f = c - o + r / 2, p = h - a, g = c - s, m = p + r, v = g + r;
        ...
        function _(t, e) {
            ...
            r.useStyle(w(n)), r.attr({silent: !i, cursor: i ? "move" : "default"}), Z(["w", "e", "n", "s", "se", "sw", "ne", "nw"], function (n) {
        ...
        function b(t, e, n, i, r, o, a) {
            ...
            s && s.setShape(k(P(t, e, [[i, r], [i + o, r + a]])))
        }
        ...
        function E(t, e, n, i) {
            ...
            if (t._track.push(n.slice()), m(t) || o) {
                if (u && !o) {
                    ...
                    var c = V.clone(h);
                    c.brushType = z(c.brushType, u), c.panelId = u === !0 ? null : u.panelId, o = t._creatingCover = a(t, c), t._covers.push(o)
                }
                if (o) {
                    var f = rt[z(t._brushType, u)], g = o.__brushOption;
                    g.range = f.getCreatingRange(P(t, o, t._track)), i && (s(t, o), f.updateCommon(t, o)), l(t, o), r = {isEnd: i}
                }
            } else i && "single" === h.brushMode && h.removeOnClick && d(t, e, n) && p(t) && (r = {isEnd: i, removeOnClick: !0});
            return r
        }
        ...
        var B = n(23), V = n(1), F = n(3), G = n(128), H = n(48), W = V.curry, Z = V.each, q = V.map, j = Math.min, U = Math.max, X = Math.pow, Y = 1e4, $ = 6, K = 6, Q = "globalPan", J = {
            w: [0, 0],
            e: [0, 1],
            n: [1, 0],
            s: [1, 1]
        ...
        var it = {
            ...
            lineX: R(0), lineY: R(1), rect: {
                ...
                createCover: function (t, e) {
                    ...
                    e.remove(e.childAt(0)), e.add(new F.Polygon({name: "main", draggable: !0, drift: W(I, t, e), ondragend: W(g, t, {isEnd: !0})}))
                }, updateCoverShape: function (t, e, n, i) {
        ...
        t.exports = {
            layout: function (t, e, n) {
                var o = r.getLayoutRect(e.getBoxLayoutParams(), {width: n.getWidth(), height: n.getHeight()}, e.get("padding"));
                r.box(e.get("orient"), t, e.get("itemGap"), o.width, o.height), i(t, e, n)
            }, addBackground: function (t, e) {
                var n = o.normalizeCssArray(e.get("padding")), i = t.getBoundingRect(), r = e.getItemStyle(["color", "opacity"]);
                r.fill = e.get("backgroundColor");
                var s = new a.Rect({
                    shape: {x: i.x - n[3], y: i.y - n[0], width: i.width + n[1] + n[3], height: i.height + n[0] + n[2]},
                    style: r,
                    silent: !0,
                    z2: -1
                });
        ...
        var i = n(1), r = n(33), o = n(134), a = function (t, e, n, i, o) {
        ...
        var i = n(1), r = n(18);
        t.exports = function (t) {
            var e = t.model, n = e.getModel("axisLabel"), o = n.get("interval");
            return "category" !== t.type || "auto" !== o ? "auto" === o ? 0 : o : r.getAxisLabelInterval(i.map(t.scale.getTicks(), t.dataToCoord, t), e.getFormattedLabels(), n.getModel("textStyle").getFont(), t.isHorizontal())
        }
    }, function (t, e, n) {
        ...
        t.exports = function (t, e) {
            e = e || {}, r.defaults(e, {text: "loading", color: "#c23531", textColor: "#000", maskColor: "rgba(255, 255, 255, 0.8)", zlevel: 0});
            ...
            return l.add(a), l.add(s), l.add(n), l.resize = function () {
                ...
                var r = a.shape.r;
                s.setShape({x: e - r, y: i - r, width: 2 * r, height: 2 * r}), n.setShape({x: 0, y: 0, width: t.getWidth(), height: t.getHeight()})
            }, l.resize(), l
        }
    }, function (t, e, n) {
        function i(t, e) {
        ...
        function r(t) {
            t = t, this.option = {}, this.option[b] = 1, this._componentsMap = {series: []}, this._seriesIndices = null, i(t, this._theme.option), h.merge(t, _, !1), this.mergeOption(t)
        }
        ...
        var h = n(1), c = n(6), d = n(10), f = h.each, p = h.filter, g = h.map, m = h.isArray, v = h.indexOf, y = h.isObject, x = n(13), _ = n(139), b = "\0_ec_inner", w = d.extend({
            constructor: w,
            init: function (t, e, n, i) {
                n = n || {}, this.option = null, this._theme = new d(n), this._optionManager = i
            },
            setOption: function (t, e, n) {
                h.assert(!(b in t), "please use chart.getOption()"), this._optionManager.setOption(t, e), this.resetOption(null, n)
            },
            resetOption: function (t, e) {
                var n = !1, i = this._optionManager;
                if (!t || "recreate" === t) {
                    var o = i.mountOption("recreate" === t);
                    this.option && "recreate" !== t ? (!e && this.restoreData(), this.mergeOption(o)) : r.call(this, o), n = !0
                }
                if ("timeline" !== t && "media" !== t || this.restoreData(), !t || "recreate" === t || "timeline" === t) {
                    var a = i.getTimelineOption(this);
                    a && (this.mergeOption(a), n = !0)
                }
                if (!t || "recreate" === t || "media" === t) {
                    var s = i.getMediaOption(this, this._api);
                    s.length && f(s, function (t) {
            ...
            queryComponents: function (t) {
                var e = t.mainType;
                if (!e)return [];
                var n = t.index, i = t.id, r = t.name, o = this._componentsMap[e];
            ...
            findComponents: function (t) {
                ...
                var i = t.query, r = t.mainType, o = e(i), a = o ? this.queryComponents(o) : this._componentsMap[r];
                return n(l(a, t))
            },
            eachComponent: function (t, e, n) {
                var i = this._componentsMap;
                if ("function" == typeof t)n = e, e = t, f(i, function (t, i) {
                    f(t, function (t, r) {
                        e.call(n, i, t, r)
                    })
                }); else if (h.isString(t))f(i[t], e, n); else if (y(t)) {
        ...
        var u = n(1), h = n(6), c = n(13), d = u.each, f = u.clone, p = u.map, g = u.merge, m = /^(min|max)?(.+)$/;
        i.prototype = {
        ...
        "undefined" != typeof navigator && (n = navigator.platform || ""), t.exports = {
            ...
            textStyle: {fontFamily: n.match(/^Win/) ? "Microsoft YaHei" : "sans-serif", fontSize: 12, fontStyle: "normal", fontWeight: "normal"},
            blendMode: null,
            animation: "auto",
        ...
        var a = n(1), s = n(146), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]], u = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"], h = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph", "heatmap", "line", "map", "parallel", "pie", "radar", "sankey", "scatter", "treemap"], c = a.each;
        t.exports = function (t) {
        ...
        var r = n(1), o = n(34), a = n(4), s = n(43), l = o.prototype, u = s.prototype, h = a.getPrecisionSafe, c = a.round, d = Math.floor, f = Math.ceil, p = Math.pow, g = Math.log, m = o.extend({
            type: "log",
            base: 10,
        ...
        var i = n(1), r = n(4), o = n(7), a = n(63), s = n(43), l = s.prototype, u = Math.ceil, h = Math.floor, c = 1e3, d = 60 * c, f = 60 * d, p = 24 * f, g = function (t, e, n, i) {
            for (; n < i;) {
                var r = n + i >>> 1;
                t[r][2] < e ? n = r + 1 : i = r
            }
            ...
            type: "time", getLabel: function (t) {
                ...
                var i = this._extent;
                if (i[0] === i[1] && (i[0] -= p, i[1] += p), i[1] === -(1 / 0) && i[0] === 1 / 0) {
                    var o = new Date;
                    i[1] = new Date(o.getFullYear(), o.getMonth(), o.getDate()), i[0] = i[1] - p
                }
                this.niceTicks(t);
                var a = this._interval;
                e || (i[0] = r.round(h(i[0] / a) * a)), n || (i[1] = r.round(u(i[1] / a) * a))
            }, niceTicks: function (t) {
                var e = this.getSetting("useUTC") ? 0 : 60 * r.getTimezoneOffset() * 1e3;
                t = t || 10;
                var n = this._extent, i = n[1] - n[0], o = i / t, s = v.length, l = g(v, o, 0, s), c = v[Math.min(l, s - 1)], d = c[2];
                if ("year" === c[0]) {
        ...
        c.prototype = {
            constructor: c, mousemove: function (t) {
                var e = t.zrX, n = t.zrY, i = this._hovered, r = this._hovered = this.findHover(e, n), o = r.target, a = i.target, s = this.proxy;
        ...
        var o = n(1), a = n(35), s = n(72), l = n(71), u = function (t, e, n) {
            var s;
        ...
        var c = n(35), d = n(1), f = n(52), p = n(11), g = n(51), m = n(153), v = n(67), y = 5, x = new p(0, 0, 0, 0), _ = new p(0, 0, 0, 0), b = function (t, e, n) {
        ...
        "use strict";
        var i = n(1), r = n(21).Dispatcher, o = n(67), a = n(66), s = function (t) {
        ...
        var i = n(68).normalizeRadian, r = 2 * Math.PI;
        t.exports = {
            ...
            for (var h = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (b === u.M && _ > 1 && (n || (h += m(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case u.Q:
                        ...
                        break;
                    case u.A:
                        var w = t[_++], M = t[_++], S = t[_++], T = t[_++], A = t[_++], I = t[_++], C = (t[_++], 1 - t[_++]), P = Math.cos(A) * S + w, k = Math.sin(A) * T + M;
                        _ > 1 ? h += m(p, g, P, k, r, l) : (y = P, x = k);
                        var L = (r - w) * T / S + w;
                        if (n) {
                            if (f.containStroke(w, M, T, A, A + I, C, e, L, l))return !0
                        } else h += s(w, M, T, A, A + I, C, L, l);
                        p = Math.cos(A + I) * S + w, g = Math.sin(A + I) * T + M;
                        break;
                    case u.R:
                        y = p = t[_++], x = g = t[_++];
                        var D = t[_++], O = t[_++], P = y + D, k = x + O;
                        if (n) {
                            if (v(y, x, P, x, e, r, l) || v(P, x, P, k, e, r, l) || v(P, k, y, k, e, r, l) || v(y, k, y, x, e, r, l))return !0
                        } else h += m(P, x, P, k, r, l), h += m(y, k, y, x, r, l);
                        break;
                    case u.Z:
                        if (n) {
        ...
        var u = n(27).CMD, h = n(96), c = n(160), d = n(97), f = n(159), p = n(68).normalizeRadian, g = n(20), m = n(98), v = h.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var u = n(21), h = n(1), c = n(23), d = n(9), f = n(162), p = u.addEventListener, g = u.removeEventListener, m = u.normalizeEvent, v = 300, y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"], x = ["touchstart", "touchend", "touchmove"], _ = {
            pointerdown: 1,
            pointerup: 1,
            pointermove: 1,
            pointerout: 1
        ...
        var i = n(5), r = i.min, o = i.max, a = i.scale, s = i.distance, l = i.add;
        t.exports = function (t, e, n, u) {
            var h, c, d, f, p = [], g = [], m = [], v = [];
            if (u) {
                d = [1 / 0, 1 / 0], f = [-(1 / 0), -(1 / 0)];
        ...
        var r = n(20), o = n(5), a = r.quadraticSubdivide, s = r.cubicSubdivide, l = r.quadraticAt, u = r.cubicAt, h = r.quadraticDerivativeAt, c = r.cubicDerivativeAt, d = [];
        t.exports = n(8).extend({
            type: "bezier-curve",
        ...
        var i = n(9), r = n(8), o = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]];
        t.exports = r.extend({
            type: "sector",
        ...
        "use strict";
        var i = n(66), r = n(1), o = r.isString, a = r.isFunction, s = r.isObject, l = n(52), u = function () {
            this.animators = []
        };
        u.prototype = {
        ...
        function i(t, e, n, i, r, o, a, s, l, u, h) {
            var g = l * (p / 180), y = f(g) * (t - n) / 2 + d(g) * (e - i) / 2, x = -1 * d(g) * (t - n) / 2 + f(g) * (e - i) / 2, _ = y * y / (a * a) + x * x / (s * s);
            _ > 1 && (a *= c(_), s *= c(_));
            var b = (r === o ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) + s * s * (y * y))) || 0, w = b * a * x / s, M = b * -s * y / a, S = (t + n) / 2 + f(g) * w - d(g) * M, T = (e + i) / 2 + d(g) * w + f(g) * M, A = v([1, 0], [(y - w) / a, (x - M) / s]), I = [(y - w) / a, (x - M) / s], C = [(-1 * y - w) / a, (-1 * x - M) / s], P = v(I, C);
            m(I, C) <= -1 && (P = p), m(I, C) >= 1 && (P = 0), 0 === o && P > 0 && (P -= 2 * p), 1 === o && P < 0 && (P += 2 * p), h.addData(u, S, T, a, s, A, P, g, o)
        }
        ...
        function r(t) {
            ...
            var r, o = n.split("|"), a = 0, l = 0, u = new s, c = s.CMD;
                ...
                for (; g < m.length && !isNaN(m[g]) && !isNaN(m[0]);) {
                    ...
                    switch (p) {
                        ...
                        case"S":
                            ...
                            r === c.C && (y += a - C[I - 4], x += l - C[I - 3]), d = c.C, T = m[g++], A = m[g++], a = m[g++], l = m[g++], u.addData(d, y, x, T, A, a, l);
                            break;
                        case"s":
                            y = a, x = l;
                            var I = u.len(), C = u.data;
                            r === c.C && (y += a - C[I - 4], x += l - C[I - 3]), d = c.C, T = a + m[g++], A = l + m[g++], a += m[g++], l += m[g++], u.addData(d, y, x, T, A, a, l);
                            break;
                        case"Q":
                            T = m[g++], A = m[g++], a = m[g++], l = m[g++], d = c.Q, u.addData(d, T, A, a, l);
                            break;
                        case"q":
                            T = m[g++] + a, A = m[g++] + l, a += m[g++], l += m[g++], d = c.Q, u.addData(d, T, A, a, l);
                            break;
                        case"T":
                            y = a, x = l;
                            var I = u.len(), C = u.data;
                            r === c.Q && (y += a - C[I - 4], x += l - C[I - 3]), a = m[g++], l = m[g++], d = c.Q, u.addData(d, y, x, a, l);
                            break;
                        case"t":
                            y = a, x = l;
                            var I = u.len(), C = u.data;
                            ...
                            break;
                        case"A":
                            _ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], T = a, A = l, a = m[g++], l = m[g++], d = c.A, i(T, A, a, l, M, S, _, b, w, d, u);
                            break;
                        case"a":
                            _ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], T = a, A = l, a += m[g++], l += m[g++], d = c.A, i(T, A, a, l, M, S, _, b, w, d, u)
                    }
        ...
        function o(t, e) {
            ...
            return e = e || {}, e.buildPath = function (t) {
                ...
                n || (n = u.create()), u.mul(n, t, n), this.dirty(!0)
            }, e
        }

        var a = n(8), s = n(27), l = n(181), u = n(16), h = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], c = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
            ...
            for (o = 0, h = 0; o < f.length;) {
                switch (n = f[o++], h = o, i = 0, n) {
                    ...
                    case x:
                        ...
                        break;
                    case y:
                        var _ = e[4], b = e[5], w = l(e[0] * e[0] + e[1] * e[1]), M = l(e[2] * e[2] + e[3] * e[3]), S = u(-e[1] / M, e[0] / w);
                        f[o++] += _, f[o++] += b, f[o++] *= w, f[o++] *= M, f[o++] += S, f[o++] += S, o += 2, h = o;
                        break;
                    case v:
        ...
        var r = n(27).CMD, o = n(5), a = o.applyTransform, s = [[], [], []], l = Math.sqrt, u = Math.atan2;
        t.exports = i
    }, function (t, e, n) {
        ...
        var h = n(1), c = n(3), d = n(6), f = n(185), p = h.each, g = h.indexOf, m = h.curry, v = ["dataToPoint", "pointToData"], y = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"], x = i.prototype;
        ...
        var _ = {
            grid: function (t, e) {
                var n = t.xAxisModels, i = t.yAxisModels, r = t.gridModels, o = {}, a = {}, s = {};
        ...
        var r = n(1), o = n(127), a = n(11), s = Math.max, l = Math.min, u = {};
        u.makeRectPanelClipPath = function (t) {
            return t = i(t), function (e, n) {
                return r.map(e, function (e) {
                    var n = e[0];
                    n = s(n, t.x), n = l(n, t.x + t.width);
                    var i = e[1];
                    return i = s(i, t.y), i = l(i, t.y + t.height), [n, i]
                })
            }
        }, u.makeLinearBrushOtherExtent = function (t, e) {
            return t = i(t), function (n) {
                var i = null != e ? e : n, r = i ? t.width : t.height, o = i ? t.x : t.y;
                return [o, o + (r || 0)]
            }
        }, u.makeRectIsTargetByCursor = function (t, e, n) {
            return t = i(t), function (i, r, a) {
                return t.contain(r[0], r[1]) && !o.onIrrelevantElement(i, e, n)
            }
        }, t.exports = u;
    }, , , function (t, e) {
        function n() {
        ...
        var r = n(3), o = n(5), a = r.Line.prototype, s = r.BezierCurve.prototype;
        ...
        var i = n(1), r = n(2);
        n(192), n(193), r.registerVisual(i.curry(n(50), "scatter", "circle", null)), r.registerLayout(i.curry(n(60), "scatter")), n(32)
    }, function (t, e, n) {
        "use strict";
        var i = n(28), r = n(19);
        t.exports = r.extend({
        ...
        var i = n(121), r = n(2).extendComponentView({
        ...
        function i(t, e, n, i, o, g, m, v, b) {
            i = i || {}, n && null != n[0] && null != n[1] || (n = y({seriesIndex: i.seriesIndex, dataIndex: i.dataIndex}, g).point);
            var w = t.axesInfo, M = "leave" === e || p(n), S = {}, T = {}, A = {list: [], map: {}}, I = [], C = {
                showPointer: _(a, T),
                showTooltip: _(s, A),
                highlight: _(l, I)
            };
            x(t.coordSysMap, function (e, o) {
                var a = e.containPoint(n);
                x(t.coordSysAxesInfo[o], function (t, e) {
                    var o = t.axis;
                    M || !a || d(i, o) || r(t, o.pointToData(n), C, !1, S)
                })
            });
            var P = {};
            return x(w, function (t, e) {
                var n = t.linkGroup;
                n && !T[e] && x(n.axesInfo, function (e, i) {
                    var r = T[i];
                    if (e !== t && r) {
                        var o = r.value;
                        n.mapper && (o = t.axis.scale.parse(n.mapper(o, f(e), f(t)))), P[t.key] = o
                    }
                })
            }), x(P, function (t, e) {
                r(w[e], t, C, !0, S)
            }), u(T, w), h(A, n, v, o), c(I, o, m, b), S
        }
        ...
        function r(t, e, n, i, r) {
            ...
            if (!a.scale.isBlank() && a.containData(e)) {
                ...
                l[0] && null == r.seriesIndex && g.extend(r, l[0]), !i && t.snap && a.containData(u) && null != u && (e = u), n.highlight("highlight", l), n.showPointer(t, e, l), n.showTooltip(t, s, u)
            }
        }
        ...
        function u(t, e) {
            x(e, function (e, n) {
                var i = e.axisPointerModel.option, r = t[n];
                r ? (!e.useHandle && (i.status = "show"), i.value = r.value, i.seriesDataIndices = (r.payloadBatch || []).slice()) : !e.useHandle && (i.status = "hide")
            })
        }

        function h(t, e, n, i) {
            if (p(e) || !t.list.length)return void i({type: "hideTip"});
        ...
        function c(t, e, n, i) {
            ...
            g.each(o, function (t, e) {
                ...
                !o[e] && s.push(t)
            }), l.length && n.dispatchAction({type: "downplay", escapeConnect: !0, batch: l}), s.length && n.dispatchAction({
                type: "highlight",
                escapeConnect: !0,
                batch: s
            })
        ...
        function d(t, e) {
            ...
            return x(t, function (t, e) {
                n &= !/^.+(AxisId|AxisName|AxisIndex)$/.test(e)
            }), !n && x([["AxisId", "id"], ["AxisIndex", "componentIndex"], ["AxisName", "name"]], function (i) {
                var r = m.normalizeToArray(t[e.dim + i[0]]);
                n |= g.indexOf(r, e.model[i[1]]) >= 0
            }), !n
        }
        ...
        function p(t) {
            return null == t[0] || isNaN(t[0]) || null == t[1] || isNaN(t[1])
        }

        var g = n(1), m = n(6), v = n(45), y = n(120), x = g.each, _ = g.curry, b = m.makeGetter();
        t.exports = i
    }, function (t, e, n) {
        n(125), n(46), n(47), n(203), n(204), n(199), n(200), n(123), n(122)
    }, function (t, e, n) {
        function i(t, e, n) {
            var i = [1 / 0, -(1 / 0)];
            return u(n, function (t) {
                var n = t.getData();
                n && u(t.coordDimToDataDim(e), function (t) {
        ...
        function o(t, e) {
            ...
            if (i) {
                var o = s.getPixelPrecision(r, [0, 500]), a = e || 0 === i[0] && 100 === i[1];
                n.setRange(a ? null : +r[0].toFixed(o), a ? null : +r[1].toFixed(o))
            }
        }

        var a = n(1), s = n(4), l = n(76), u = a.each, h = s.asc, c = function (t, e, n, i) {
        ...
        c.prototype = {
            constructor: c, hostedBy: function (t) {
                ...
                return e.eachSeries(function (n) {
                    if (l.isCoordSupported(n.get("coordinateSystem"))) {
                ...
                var e = this._dataExtent, n = this.getAxisModel(), i = n.axis.scale, r = this._dataZoomModel.getRangePropMode(), o = [0, 100], a = [t.start, t.end], l = [];
                return u(["startValue", "endValue"], function (e) {
                    l.push(null != t[e] ? i.parse(t[e]) : null)
                }), u([0, 1], function (t) {
                    var n = l[t], u = a[t];
                    "percent" === r[t] ? (null == u && (u = o[t]), n = i.parse(s.linearMap(u, o, e, !0))) : u = s.linearMap(n, e, o, !0), l[t] = n, a[t] = u
                ...
                if (t === this._dataZoomModel) {
                    var n = this._dimName, i = this.getTargetSeriesModels(), r = t.get("filterMode"), o = this._valueWindow, a = this.getOtherAxisModel();
                    t.get("$fromToolbox") && a && "category" === a.get("type") && (r = "empty"), u(i, function (t) {
                        var i = t.getData();
        ...
        t.exports = n(46).extend({type: "dataZoom.inside", defaultOption: {disabled: !1, zoomLock: !1}})
    }, function (t, e, n) {
        function i(t) {
            var e = [0, 100];
        ...
        var r = n(47), o = n(1), a = n(78), s = n(205), l = o.bind, u = r.extend({
            type: "dataZoom.inside", init: function (t, e) {
                this._range
            }, render: function (t, e, n, i) {
                u.superApply(this, "render", arguments), s.shouldRecordRange(i, t.id) && (this._range = t.getPercentRange()), o.each(this.getTargetCoordInfo(), function (e, i) {
        ...
        var r = n(1), o = n(3), a = n(37), s = n(47), l = o.Rect, u = n(4), h = u.linearMap, c = n(12), d = n(78), f = n(21), p = u.asc, g = r.bind, m = r.each, v = 7, y = 1, x = 30, _ = "horizontal", b = "vertical", w = 5, M = ["line", "bar", "candlestick", "scatter"], S = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
            ...
            _resetLocation: function () {
                var t = this.dataZoomModel, e = this.api, n = this._findCoordRect(), i = {
                    width: e.getWidth(),
                    height: e.getHeight()
                }, o = this._orient === _ ? {right: i.width - n.x - n.width, top: i.height - x - v, width: n.width, height: x} : {
                    right: v,
                    top: n.y,
                    width: x,
                    height: n.height
            ...
            _renderDataShadow: function () {
                ...
                if (t) {
                    var e = this._size, n = t.series, i = n.getRawData(), a = n.getShadowDim ? n.getShadowDim() : t.otherDim;
                    if (null != a) {
                        var s = i.getDataExtent(a), l = .3 * (s[1] - s[0]);
                        s = [s[0] - l, s[1] + l];
                        var u, c = [0, e[1]], d = [0, e[0]], f = [[e[0], 0], [0, 0]], p = [], g = d[1] / (i.count() - 1), m = 0, v = Math.round(i.count() / e[0]);
            ...
            _renderHandle: function () {
                ...
                i.add(t.filler = new l({
                    ...
                    style: {stroke: a.get("dataBackgroundColor") || a.get("borderColor"), lineWidth: y, fill: "rgba(0,0,0,0)"}
                })));
                ...
                m([0, 1], function (t) {
                    ...
                    null != h && (r.style.fill = h), i.add(e[t] = r);
            ...
            _updateInterval: function (t, e) {
                var n = this._handleEnds, i = this._getViewExtent();
                d(e, n, i, "all" === t || this.dataZoomModel.get("zoomLock") ? "rigid" : "cross", t), this._range = p([h(n[0], i, [0, 100], !0), h(n[1], i, [0, 100], !0)])
            },
            _updateView: function (t) {
                var e = this._displayables, n = this._handleEnds, i = p(n.slice()), r = this._size;
                m([0, 1], function (t) {
                    var i = e.handles[t], o = this._handleHeight;
                    i.attr({scale: [o, o], position: [n[t], r[1] / 2 - o / 2]})
                }, this), e.filler.setShape({x: i[0], y: 0, width: i[1] - i[0], height: r[1]}), this._updateDataInfo(t)
            },
            _updateDataInfo: function (t) {
                function e(t) {
                    var e = o.getTransform(i.handles[t].parent, this.group), n = o.transformDirection(0 === t ? "right" : "left", e), l = this._handleWidth / 2 + w, u = o.applyTransform([d[t] + (0 === t ? -l : l), this._size[1] / 2], e);
                    r[t].setStyle({x: u[0], y: u[1], textVerticalAlign: a === _ ? "middle" : n, textAlign: a === _ ? n : "center", text: s[t]})
                }
        ...
        function r(t, e, n) {
            var i = new c(t.getZr());
            return i.enable(), i.on("pan", f(a, n)), i.on("zoom", f(s, n)), i
        }
        ...
        function l(t, e) {
            ...
            h.each(t.dataZoomInfos, function (t) {
                var i = e(t);
                i && n.push({dataZoomId: t.dataZoomId, start: i[0], end: i[1]})
            }), t.dispatchAction(n)
        }
        ...
        var h = n(1), c = n(93), d = n(37), f = h.curry, p = "\0_ec_dataZoom_roams", g = {
            register: function (t, e) {
                ...
                l || (l = n[s] = {
                    ...
                    dataZoomInfos: {},
                    count: 0
                }, l.controller = r(t, e, l), l.dispatchAction = h.curry(u, t)), l.controller.setPointerChecker(e.containsPoint), d.createOrUpdate(l, "dispatchAction", e.throttleRate, "fixRate"), !l.dataZoomInfos[a] && l.count++, l.dataZoomInfos[a] = e
        ...
        n(125), n(46), n(47), n(201), n(202), n(123), n(122)
    }, function (t, e, n) {
        function i(t, e, n, i) {
            var r = n.type, o = f[r.charAt(0).toUpperCase() + r.slice(1)], a = new o(n);
            e.add(a), i[t] = a, a.__ecGraphicId = t
        }
        ...
        function r(t, e) {
            ...
            n && ("group" === t.type && t.traverse(function (t) {
                r(t, e)
            }), delete e[t.__ecGraphicId], n.remove(t))
        }
        ...
        var h = n(2), c = n(1), d = n(6), f = n(3), p = n(12);
        ...
        h.extendComponentView({
            type: "graphic", init: function (t, e) {
                ...
                if (n) {
                    ...
                    c.each(n, function (t) {
                        var e = t.$action, n = t.id, l = a[n], u = t.parentId, h = null != u ? a[u] : s;
                        t.hv && t.hv[1] && "text" === t.type && (t.style = c.defaults({textBaseline: "middle"}, t.style), t.style.textVerticalAlign = null);
                        var d = o(t);
                        e && "merge" !== e ? "replace" === e ? (r(l, a), i(n, h, d, a)) : "remove" === e && r(l, a) : l ? l.attr(d) : i(n, h, d, a), a[n] && (a[n].__ecGraphicWidth = t.width, a[n].__ecGraphicHeight = t.height)
                    })
                }
        ...
        var a = n(1), s = n(24), l = n(3), u = n(129), h = a.curry;
        t.exports = n(2).extendComponentView({
                ...
                if (s.removeAll(), t.get("show")) {
                    ...
                    a.each(t.getData(), function (a) {
                        ...
                        if (!f[u])if (p) {
                            ...
                            x.on("click", h(i, u, n)).on("mouseover", h(r, p, null, n)).on("mouseout", h(o, p, null, n)), f[u] = !0
                            ...
                            if (!f[u] && e.legendDataProvider) {
                                ...
                                m.on("click", h(i, u, n)).on("mouseover", h(r, e, u, n)).on("mouseout", h(o, e, u, n)), f[u] = !0
                            }
                        }, this)
                    }, this), u.layout(s, t, n), u.addBackground(s, t)
                }
            }, _createItem: function (t, e, n, i, r, o, u, h) {
                var c = n.get("itemWidth"), d = n.get("itemHeight"), f = n.get("inactiveColor"), p = n.isSelected(t), g = new l.Group, m = e.getModel("textStyle"), v = e.get("icon"), y = e.getModel("tooltip"), x = y.parentModel;
        ...
        var l = n(1), u = n(14), h = n(4), c = n(81), d = n(106), f = function (t, e, n, i) {
        ...
        n(80).extend({
            type: "markPoint", updateLayout: function (t, e, n) {
                e.eachSeries(function (t) {
                    ...
                    e && (i(e.getData(), t, n), this.markerGroupMap[t.name].updateLayout(e))
                }, this)
        ...
        i.extendComponentModel({
            ...
            type: "title", render: function (t, e, n) {
                if (this.group.removeAll(), t.get("show")) {
                    ...
                    var w = new r.Rect({
                        shape: {x: m.x - _[3], y: m.y - _[0], width: m.width + _[1] + _[3], height: m.height + _[0] + _[2]},
                        style: b,
                        silent: !0
                    });
        ...
        (function (e) {
            ...
            var r = n(29), o = n(1), a = n(3), s = n(10), l = n(48), u = n(129), h = n(17);
            t.exports = n(2).extendComponentView({
                type: "toolbox", render: function (t, e, n, c) {
                    ...
                    if (p.removeAll(), t.get("show")) {
                        ...
                        o.each(m, function (t, e) {
                            ...
                            if (i && e) {
                                var r = h.getBoundingRect(e, i.font), o = t.position[0] + p.position[0], a = t.position[1] + p.position[1] + g, s = !1;
        ...
        function h(t) {
            for (var e = t.split(/\n+/g), n = s(e.shift()), i = [], r = 0; r < e.length; r++) {
                ...
                isNaN(a[0]) ? (u = !0, l = a[0], a = a.slice(1), i[r] = {name: l, value: []}, o = i[r].value) : o = i[r] = [];
        ...
        var s = n(1), l = n(126), u = n(184), h = n(124), c = s.each;
        n(206);
        ...
        f._onBrush = function (t, e) {
            function n(t, e, n) {
                var r = i(t, e.getAxis(t).model, a);
                r && (o[r.id] = {dataZoomId: r.id, startValue: n[0], endValue: n[1]})
            }
                ...
                if (e) {
                    ...
                    null == o || "all" == o || s.isArray(o) || (o = o === !1 || "none" === o ? [] : [o]), n(t, function (e, n) {
                        if (null == o || "all" == o || s.indexOf(o, n) !== -1) {
                            var a = {type: "select", $fromToolbox: !0, id: d + t + n};
                            a[r] = n, i.push(a)
                        }
                    })
                }
        ...
        var a = {
            line: function (t, e, n, i) {
                ...
                if ("line" === t || "bar" === t)return r.merge({id: e, stack: "__ec_magicType_stack__"}, i.get("option.stack") || {}, !0)
        ...
        }, n(29).register("restore", i), n(2).registerAction({type: "restore", event: "restore", update: "prepareAndUpdate"}, function (t, e) {
        ...
        n(55), n(234), n(235), n(2).registerAction({type: "showTip", event: "showTip", update: "tooltip:manuallyShowTip"}, function () {
        ...
        var s = n(1), l = n(22), u = n(21), h = n(7), c = s.each, d = h.toCamelCase, f = n(9), p = ["", "-webkit-", "-moz-", "-o-"], g = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
        a.prototype = {
        ...
        var u = n(233), h = n(1), c = n(7), d = n(4), f = n(3), p = n(120), g = n(12), m = n(9), v = n(10), y = n(121), x = n(18), _ = n(75), b = h.bind, w = h.each, M = d.parsePercent, S = new f.Rect({
            shape: {
                x: -1,
                y: -1,
                width: 2,
            ...
            type: "tooltip", init: function (t, e) {
                ...
                if (i.from !== this.uid && !m.node) {
                    ...
                    if (i.tooltip && null != i.x && null != i.y) {
                        var s = S;
                        s.position = [i.x, i.y], s.update(), s.tooltip = i.tooltip, this._tryShow({offsetX: i.x, offsetY: i.y, target: s}, o)
                        ...
                        null != u && null != h && this._tryShow({offsetX: u, offsetY: h, position: i.position, target: l.el, event: {}}, o)
                    } else null != i.x && null != i.y && (n.dispatchAction({type: "updateAxisPointer", x: i.x, y: i.y}), this._tryShow({
                        offsetX: i.x,
                        offsetY: i.y,
                        position: i.position,
                ...
                if (null != o && null != a && null != s) {
                    ...
                    if (l) {
                        ...
                        if ("axis" === t.get("trigger"))return n.dispatchAction({type: "updateAxisPointer", seriesIndex: o, dataIndex: a}), !0
                    }
                }
                ...
                if (null == d || "item" === d) {
                    ...
                    }), n({type: "showTip", dataIndexInside: l, dataIndex: h.getRawIndex(l), seriesIndex: o, from: this.uid})
                }
                ...
                e = e || t.get("position");
                var p = r.getSize(), m = t.get("align"), v = t.get("verticalAlign"), y = c && c.getBoundingRect().clone();
                ...
                return w(e, function (e, i) {
                    ...
                    n &= r.length === a.length, w(r, function (t, e) {
                        var i = a[e] || {}, r = t.seriesDataIndices || [], o = i.seriesDataIndices || [];
                        n &= t.value === i.value && t.axisType === i.axisType && t.axisId === i.axisId && r.length === o.length, w(r, function (t, e) {
                            var i = o[e];
        ...
        if (!n(9).canvasSupported) {
            var i = n(5), r = n(11), o = n(27).CMD, a = n(22), s = n(17), l = n(86), u = n(38), h = n(53), c = n(85), d = n(8), f = n(27), p = n(39), g = n(182), m = Math.round, v = Math.sqrt, y = Math.abs, x = Math.cos, _ = Math.sin, b = Math.max, w = i.applyTransform, M = ",", S = "progid:DXImageTransform.Microsoft", T = 21600, A = T / 2, I = 1e5, C = 1e3, P = function (t) {
                ...
                if (null != i)if (i instanceof p) {
                    ...
                    for (var A = S.length, I = [], C = [], P = 0; P < A; P++) {
                        var k = S[P], L = R(k.color);
                        C.push(k.offset * l + s + " " + L[0]), 0 !== P && P !== A - 1 || I.push(L)
                    }
                    if (A >= 2) {
                        var D = I[0][0], O = I[1][0], E = I[0][1] * e.opacity, z = I[1][1] * e.opacity;
                        t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = D, t.color2 = O, t.colors = C.join(","), t.opacity = z, t.opacity2 = E
                    }
                ...
                null != n[e] && "none" !== n[e] && (r || !r && n.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", n[e] instanceof p && O(t, o), o || (o = g.createNode(e)), r ? B(o, n, i) : V(o, n), D(t, o)) : (t[r ? "filled" : "stroked"] = "false", O(t, o))
            }, G = [[], [], []], H = function (t, e) {
                ...
                for (a = 0; a < t.length;) {
                    switch (r = t[a++], i = "", n = 0, r) {
                        ...
                        case h:
                            ...
                            break;
                        case d:
                            var P = 0, k = 0, L = 1, D = 1, O = 0;
                            e && (P = e[4], k = e[5], L = v(e[0] * e[0] + e[1] * e[1]), D = v(e[2] * e[2] + e[3] * e[3]), O = Math.atan2(-e[1] / D, e[0] / L));
                            var E = t[a++], z = t[a++], N = t[a++], R = t[a++], B = t[a++] + O, V = t[a++] + B + O;
                            a++;
                            var F = t[a++], H = E + x(B) * N, W = z + _(B) * R, b = E + x(V) * N, S = z + _(V) * R, Z = F ? " wa " : " at ";
                            Math.abs(H - b) < 1e-4 && (Math.abs(V - B) > .01 ? F && (H += 270 / T) : Math.abs(W - z) < 1e-4 ? F && H < E || !F && H > E ? S -= 270 / T : S += 270 / T : F && W < z || !F && W > z ? b += 270 / T : b -= 270 / T), p.push(Z, m(((E - N) * L + P) * T - A), M, m(((z - R) * D + k) * T - A), M, m(((E + N) * L + P) * T - A), M, m(((z + R) * D + k) * T - A), M, m((H * L + P) * T - A), M, m((W * D + k) * T - A), M, m((b * L + P) * T - A), M, m((S * D + k) * T - A)), s = b, l = S;
                            break;
                        case o.R:
                            var q = G[0], j = G[1];
            ...
            d.prototype.brushVML = function (t) {
                ...
                this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1), n.path = H(l.data, this.transform), n.style.zIndex = E(this.zlevel, this.z, this.z2), D(t, n), null != e.text ? this.drawRectText(t, this.getBoundingRect()) : this.removeRectText(t)
            ...
            h.prototype.brushVML = function (t) {
                ...
                if (r) {
                    var u = i.x || 0, h = i.y || 0, c = i.width, d = i.height, f = i.sWidth, p = i.sHeight, y = i.sx || 0, x = i.sy || 0, _ = f && p, T = this._vmlEl;
                    T || (T = g.doc.createElement("div"), P(T), this._vmlEl = T);
                    var A, I = T.style, C = !1, k = 1, L = 1;
                    if (this.transform && (A = this.transform, k = v(A[0] * A[0] + A[1] * A[1]), L = v(A[2] * A[2] + A[3] * A[3]), C = A[1] || A[2]), C) {
                        var O = [u, h], z = [u + c, h], N = [u, h + d], R = [u + c, h + d];
                        w(O, O, A), w(z, z, A), w(N, N, A), w(R, R, A);
                        var B = b(O[0], z[0], N[0], R[0]), V = b(O[1], z[1], N[1], R[1]), F = [];
                        F.push("M11=", A[0] / k, M, "M12=", A[2] / L, M, "M21=", A[1] / k, M, "M22=", A[3] / L, M, "Dx=", m(u * k + A[4]), M, "Dy=", m(h * L + A[5])), I.padding = "0 " + m(B) + "px " + m(V) + "px 0", I.filter = S + ".Matrix(" + F.join("") + ", SizingMethod=clip)"
                    } else A && (u = u * k + A[4], h = h * L + A[5]), I.filter = "", I.left = m(u) + "px", I.top = m(h) + "px";
                    var G = this._imageEl, H = this._cropEl;
                    G || (G = g.doc.createElement("div"), this._imageEl = G);
                    var Z = G.style;
                    if (_) {
                        if (e && n)Z.width = m(k * e * c / f) + "px", Z.height = m(L * n * d / p) + "px"; else {
                            var q = new Image, j = this;
                            q.onload = function () {
                                q.onload = null, e = q.width, n = q.height, Z.width = m(k * e * c / f) + "px", Z.height = m(L * n * d / p) + "px", j._imageWidth = e, j._imageHeight = n, j._imageSrc = r
                            }, q.src = r
                        }
                        H || (H = g.doc.createElement("div"), H.style.overflow = "hidden", this._cropEl = H);
                        var U = H.style;
                        U.width = m((c + y * c / f) * k), U.height = m((d + x * d / p) * L), U.filter = S + ".Matrix(Dx=" + -y * c / f * k + ",Dy=" + -x * d / p * L + ")", H.parentNode || T.appendChild(H), G.parentNode != H && H.appendChild(G)
                    } else Z.width = m(k * c) + "px", Z.height = m(L * d) + "px", T.appendChild(G), H && H.parentNode && (T.removeChild(H), this._cropEl = null);
                    var X = "", Y = i.opacity;
                    Y < 1 && (X += ".Alpha(opacity=" + m(100 * Y) + ") "), X += S + ".AlphaImageLoader(src=" + r + ", SizingMethod=scale)", Z.filter = X, T.style.zIndex = E(this.zlevel, this.z, this.z2), D(t, T), null != i.text && this.drawRectText(t, this.getBoundingRect())
                }
            ...
            for (var K = new r, Q = function (t, e, n, i) {
                ...
                if (null != o && (o += ""), o) {
                    var a, l, u = r.textAlign, h = $(r.textFont), c = h.style + " " + h.variant + " " + h.weight + " " + h.size + 'px "' + h.family + '"', d = r.textBaseline, f = r.textVerticalAlign;
                    ...
                    I ? (T = I.firstChild, b = T.nextSibling, S = b.nextSibling) : (I = A("line"), b = A("path"), S = A("textpath"), T = A("skew"), S.style["v-text-align"] = "left", P(I), b.textpathok = !0, S.on = !0, I.from = "0 0", I.to = "1000 0.05", D(I, T), D(I, b), D(I, S), this._textVmlEl = I);
                    var C = [a, l], L = I.style;
                    p && i ? (w(C, C, p), T.on = !0, T.matrix = p[0].toFixed(3) + M + p[2].toFixed(3) + M + p[1].toFixed(3) + M + p[3].toFixed(3) + ",0,0", T.offset = (m(C[0]) || 0) + "," + (m(C[1]) || 0), T.origin = "0 0", L.left = "0px", L.top = "0px") : (T.on = !1, L.left = m(a) + "px", L.top = m(l) + "px"), S.string = k(o);
                    try {
                        S.style.font = c
                    } catch (O) {
                    }
                    F(I, "fill", {fill: i ? r.fill : r.textFill, opacity: r.opacity}, this), F(I, "stroke", {
                        stroke: i ? r.stroke : r.textStroke,
                        opacity: r.opacity,
                        lineDash: r.lineDash
                    }, this), I.style.zIndex = E(this.zlevel, this.z, this.z2), D(t, I)
                }
            }, J = function (t) {
        ...
        n(238), n(87).registerPainter("vml", n(237))
    }])
});